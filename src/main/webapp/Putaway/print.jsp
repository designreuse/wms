...
<body style="page-break-after: always;">
	<div style="width: 100%; margin-top: 20px" align="center">
		<h2>Putaway List Identifier : ${listId}</h2>
		<img src='<c:url value="/Barcode/generate/${listId}"/>'>
		<table style="margin-top: 20px;" class="table-border">
			...
			<tbody style="font-size:0.8em;">
				<c:forEach var="inventory" items="${putawayList}">
					<tr>
		...
		<table style="margin-top: 50px" width="100%">
			<tr>
				<td width="50%" align="left">Warehouse Boy :&nbsp;&nbsp;${warehouseBoy}</td>
