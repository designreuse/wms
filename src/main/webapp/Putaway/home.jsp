		...
		Putaway Desk
			...
			<input type="hidden" value="${alert}" id="alertSet" />
				<div class="row" style="margin-bottom: 20px;margin-top: 20px">
					<form action='<c:url value="/Putaway/check" />' method="post"
							id="form">
						<input type="hidden" name="listId" value="${putawayList.id}" />
						<div class="col-lg-12" style="margin-top: 20px">
							<div class="col-lg-4">
								<label>Rule : </label>
								<select name="manualRuleId" class="form-control" id="manualRuleId">
				...
				<div class="box-content">
					<div class="row">
						...
						<div class="col-lg-12"
							...
							<form id="form2" method="post" action="<c:url value="/Putaway/Directdispatch"/>">
